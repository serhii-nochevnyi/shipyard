...
const results = await parallel(
  tickets.map((t) => () => {
    ...
    const prompt = [
        ...
        `4a. Keep added code comments rare and purposeful. Preserve required directives, licences, generated markers, security constraints and non-obvious invariants; remove narration that repeats the code.`,
