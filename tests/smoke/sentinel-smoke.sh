...
if grep -qF -- 'shipyard:gsd-sync generated' "$proj/.planning/STATE.md"; then
  ok "state-sync finalizes the native GSD projection"
else
  bad "state-sync finalizes the native GSD projection" "STATE.md was not generated by gsd-sync"
fi
